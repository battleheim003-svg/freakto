...
def build_fold_bounds(dataset: pd.DataFrame, n: int, verbose: bool = False) -> list:
    """آموزش مدل برای هر فولد walk-forward و محاسبه‌ی احتمال‌ها روی بازه‌ی تست آن فولد."""
    fold_bounds = []
...
def run():
    ...
    fold_bounds = build_fold_bounds(dataset, n, verbose=True)
