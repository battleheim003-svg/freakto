"""
Canonical packaged paper-trading dashboard
...
def main():
    ...
    parser.add_argument("--web", action="store_true", help="Open the unified local Control Center.")
    ...
    if args.web:
        ...
        print(
            "[DEPRECATED] paper_trading_dashboard.py --web now opens Freakto Control Center.",
            file=sys.stderr,
        )
