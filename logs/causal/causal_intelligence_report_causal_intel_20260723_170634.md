...
Run ID                 : causal_intel_20260723_170634
Symbol / TF            : BTC/USDT | 4h
Collect Live Sources   : True
Sources OK/Failed      : 8 / 2
Trusted Sources OK     : 7
Manual Events Loaded   : 0
Auto Events Loaded     : 4
...
- Evidence Strength    : 0.6549 (MEDIUM)
...
- coingecko_global: Global crypto cap 24h change=-2.027%, BTC dominance=56.57%, volume=$60.34B.
- defillama_tvl: DeFi TVL approx 7d change=1.051%, latest=$142.06B.
- defillama_stablecoins: Stablecoin listed circulating supply snapshot=$309.98B across 411 assets.
