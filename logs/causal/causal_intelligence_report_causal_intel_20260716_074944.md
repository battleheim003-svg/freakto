...
Run ID                 : causal_intel_20260716_074944
...
- Conflicting evidence: DeFi TVL approx 7d change=4.768%, latest=$140.85B.
...
- coingecko_global: Global crypto cap 24h change=-0.189%, BTC dominance=56.13%, volume=$66.76B.
- defillama_tvl: DeFi TVL approx 7d change=4.768%, latest=$140.85B.
- defillama_stablecoins: Stablecoin listed circulating supply snapshot=$309.0B across 410 assets.
