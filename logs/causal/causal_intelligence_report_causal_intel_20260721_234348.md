...
Run ID                 : causal_intel_20260721_234348
...
- coingecko_global: Global crypto cap 24h change=1.249%, BTC dominance=56.84%, volume=$70.26B.
- defillama_tvl: DeFi TVL approx 7d change=5.611%, latest=$142.82B.
- defillama_stablecoins: Stablecoin listed circulating supply snapshot=$309.04B across 410 assets.
...
- alternative_fng: Fear & Greed=25.0 (Extreme Fear); used only as sentiment/crowding context.
