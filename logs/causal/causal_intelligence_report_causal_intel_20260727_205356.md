...
Run ID                 : causal_intel_20260727_205356
...
- Conflicting evidence: SEC Press Releases RSS: The Securities and Exchange Commission today announced that Sam Waldon, Principal Deputy Director of the Division of Enforcement, will depart the agency on 
...
- coingecko_global: Global crypto cap 24h change=0.271%, BTC dominance=56.53%, volume=$66.74B.
- defillama_tvl: DeFi TVL approx 7d change=1.896%, latest=$143.01B.
- defillama_stablecoins: Stablecoin listed circulating supply snapshot=$309.06B across 413 assets.
...
- alternative_fng: Fear & Greed=30.0 (Fear); used only as sentiment/crowding context.
