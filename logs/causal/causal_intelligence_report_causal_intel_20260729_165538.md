...
Run ID                 : causal_intel_20260729_165538
...
- Event Risk           : HIGH
- Technical Conflict   : MEDIUM
- Alignment            : CONFLICT_WITH_EXTERNAL_CONTEXT
- Verdict              : CAUSAL_HYPOTHESIS_WEAK_EVIDENCE
- Evidence Strength    : 0.4757 (LOW)
- Claim Status         : WEAK_HYPOTHESIS
- Independent Sources  : 5
- Direction Agreement  : 0.0

Alternative Explanations:
- Conflicting evidence: SEC Press Releases RSS: The Securities and Exchange Commission announced today that it will host a roundtable on Sept. 17, 2026, to discuss moving towards 24-hour trading in the U.
...
Internal Causes:
- STRUCTURE_BREAKOUT_WEAK_VOLUME_CONFIRMATION: dir=SHORT | conf=LOW | score=12 | structure_score>=10 but volume support is weak/missing
...
- coingecko_global: Global crypto cap 24h change=-0.651%, BTC dominance=56.5%, volume=$59.77B.
- defillama_tvl: DeFi TVL approx 7d change=-1.486%, latest=$141.4B.
- defillama_stablecoins: Stablecoin listed circulating supply snapshot=$307.61B across 413 assets.
...
- alternative_fng: Fear & Greed=29.0 (Fear); used only as sentiment/crowding context.
