...
Run ID                 : causal_intel_20260718_071331
...
- Conflicting evidence: Global crypto cap 24h change=1.154%, BTC dominance=56.42%, volume=$56.21B.
...
- coingecko_global: Global crypto cap 24h change=1.154%, BTC dominance=56.42%, volume=$56.21B.
- defillama_tvl: DeFi TVL approx 7d change=1.264%, latest=$138.8B.
