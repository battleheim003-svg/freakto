...
Run ID                 : causal_intel_20260722_093908
...
- Conflicting evidence: DeFi TVL approx 7d change=2.147%, latest=$142.71B.
...
- coingecko_global: Global crypto cap 24h change=-0.603%, BTC dominance=56.74%, volume=$70.49B.
- defillama_tvl: DeFi TVL approx 7d change=2.147%, latest=$142.71B.
- defillama_stablecoins: Stablecoin listed circulating supply snapshot=$308.92B across 411 assets.
...
- alternative_fng: Fear & Greed=33.0 (Fear); used only as sentiment/crowding context.
