...
Run ID                 : causal_intel_20260720_112501
...
- Conflicting evidence: DeFi TVL approx 7d change=2.104%, latest=$139.6B.
...
- coingecko_global: Global crypto cap 24h change=-0.198%, BTC dominance=56.42%, volume=$54.1B.
- defillama_tvl: DeFi TVL approx 7d change=2.104%, latest=$139.6B.
- defillama_stablecoins: Stablecoin listed circulating supply snapshot=$309.48B across 410 assets.
