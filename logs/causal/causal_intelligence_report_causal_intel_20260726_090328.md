...
Run ID                 : causal_intel_20260726_090328
...
- coingecko_global: Global crypto cap 24h change=0.844%, BTC dominance=56.47%, volume=$38.27B.
- defillama_tvl: DeFi TVL approx 7d change=1.025%, latest=$141.33B.
- defillama_stablecoins: Stablecoin listed circulating supply snapshot=$309.65B across 413 assets.
...
- alternative_fng: Fear & Greed=26.0 (Fear); used only as sentiment/crowding context.
