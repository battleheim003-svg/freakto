...
Run ID                 : causal_intel_20260722_234440
...
- Conflicting evidence: DeFi TVL approx 7d change=2.666%, latest=$143.29B.
...
- coingecko_global: Global crypto cap 24h change=-0.631%, BTC dominance=56.74%, volume=$66.2B.
- defillama_tvl: DeFi TVL approx 7d change=2.666%, latest=$143.29B.
- defillama_stablecoins: Stablecoin listed circulating supply snapshot=$310.27B across 411 assets.
