...
Run ID                 : causal_intel_20260720_234231
...
- Conflicting evidence: DeFi TVL approx 7d change=3.613%, latest=$141.67B.
...
- coingecko_global: Global crypto cap 24h change=0.748%, BTC dominance=56.56%, volume=$72.29B.
- defillama_tvl: DeFi TVL approx 7d change=3.613%, latest=$141.67B.
- defillama_stablecoins: Stablecoin listed circulating supply snapshot=$308.56B across 410 assets.
