...
Run ID                 : causal_intel_20260722_170346
...
- Conflicting evidence: DeFi TVL approx 7d change=2.579%, latest=$143.17B.
...
- coingecko_global: Global crypto cap 24h change=-0.252%, BTC dominance=56.68%, volume=$67.87B.
- defillama_tvl: DeFi TVL approx 7d change=2.579%, latest=$143.17B.
- defillama_stablecoins: Stablecoin listed circulating supply snapshot=$309.13B across 411 assets.
