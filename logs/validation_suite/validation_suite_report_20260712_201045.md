...
==============================================================================================================
Created UTC      : 2026-07-12T20:10:44.887121+00:00
...
==============================================================================================================
Created UTC          : 2026-07-12T20:10:44.919355+00:00
...
==============================================================================================================
Created UTC       : 2026-07-12T20:10:44.957416+00:00
...
Scans/Dec/Eval: 46 / 63 / 58
Latest        : NEUTRAL | Rec IGNORE | MTF NEUTRAL
Avg Score/Conf/Opp: 38.22 / 31.61% / 20.99
...
Scans/Dec/Eval: 46 / 0 / 0
Latest        : NEUTRAL | Rec IGNORE | MTF NEUTRAL
Avg Score/Conf/Opp: 42.11 / 36.33% / 6.85
Directional/T1/Avg24: 0.00% / 0.00% / 0.0000%
Paper        : closed 0 | win 0.00% | exp 0.0000R | PF 0.0000
Rec rates    : actionable 0.00% | monitor 0.00% | ignore 10.87%
...
Avg Score/Conf/Opp: 40.26 / 35.74% / 53.32
Directional/T1/Avg24: 0.00% / 0.00% / 0.0000%
Paper        : closed 0 | win 0.00% | exp 0.0000R | PF 0.0000
Rec rates    : actionable 0.00% | monitor 6.52% | ignore 4.35%
Note         : نماد در حال رصد است اما هنوز Edge کافی ندارد.
Blocker      : Complete evaluations کمتر از 30 است: 0
Blocker      : Closed paper trades کمتر از 30 است: 0
--------------------------------------------------------------------------------------------------------------
...
Scans/Dec/Eval: 46 / 0 / 0
Latest        : NEUTRAL | Rec IGNORE | MTF NEUTRAL
Avg Score/Conf/Opp: 35.57 / 30.33% / 31.88
Directional/T1/Avg24: 0.00% / 0.00% / 0.0000%
Paper        : closed 0 | win 0.00% | exp 0.0000R | PF 0.0000
Rec rates    : actionable 0.00% | monitor 4.35% | ignore 6.52%
Note         : نماد در حال رصد است اما هنوز Edge کافی ندارد.
Blocker      : Complete evaluations کمتر از 30 است: 0
Blocker      : Closed paper trades کمتر از 30 است: 0
--------------------------------------------------------------------------------------------------------------
...
Scans/Dec/Eval: 46 / 0 / 0
Latest        : NEUTRAL | Rec IGNORE | MTF NEUTRAL
Avg Score/Conf/Opp: 33.70 / 26.85% / 15.51
Directional/T1/Avg24: 0.00% / 0.00% / 0.0000%
Paper        : closed 0 | win 0.00% | exp 0.0000R | PF 0.0000
Rec rates    : actionable 0.00% | monitor 2.17% | ignore 8.70%
Note         : نماد در حال رصد است اما هنوز Edge کافی ندارد.
...
==============================================================================================================
Created UTC       : 2026-07-12T20:10:44.971800+00:00
...
==============================================================================================================
Created UTC      : 2026-07-12T20:10:45.013835+00:00
...
==============================================================================================================
Status                 : NO_BACKTEST_DATA
Run ID                 : backtest_diag_20260712_201045
Rows / Complete        : 0 / 0
Directional Samples    : 0
Directional Win Rate   : 0.00%
Target 1 Hit Rate      : 0.00%
...
==============================================================================================================
Status                 : NO_BACKTEST_DATA
Run ID                 : gate_sim_20260712_201045
Horizon                : 24h
Min Samples            : 30
Rows / Complete        : 0 / 0
Directional Samples    : 0
...
Run ID                 : forward_regime_label_20260712_201045
Apply Changes          : False
Decision Rows          : 63
Known Before / After   : 61 / 61
Unknown Before / After : 2 / 2
...
Recommendations:
→ هنوز 2 تصمیم Forward بدون regime قابل‌اعتماد مانده؛ اجرای‌های جدید بعد از v6.2.1 باید این عدد را کاهش دهد.
...
Run ID                 : shadow_gate_20260712_201045
Horizon                : 24h
Min Samples            : 30
Decisions              : 63
...
==============================================================================================================
Status: NO_BACKTEST_DATA
Run ID: regime_gate_matrix_20260712_201045
Horizon: 24h
...
Run ID                 : forward_shadow_coverage_20260712_201045
Horizon                : 24h
Decision Rows          : 63
Directional Decisions  : 36
Evaluation Rows        : 62
...
- TRENDING_BULL: rows=52 | directional=35 | share=82.54% | direct=0 | proxy/text=0
- TRENDING_BEAR: rows=8 | directional=1 | share=12.7% | direct=0 | proxy/text=0
- UNKNOWN: rows=2 | directional=0 | share=3.17% | direct=0 | proxy/text=0
- SIDEWAYS: rows=1 | directional=0 | share=1.59% | direct=0 | proxy/text=0
...
Run ID                 : root_cause_forward_20260712_201045
...
Run ID                 : root_cause_samples_20260712_201045
Evaluations File       : logs/decision_evaluations.csv
Rows / Complete        : 62 / 58
Root Cause Rows        : 11
Evaluated Cells        : 28
...
Run ID                 : evidence_graph_20260712_201045
Evaluations File       : logs/decision_evaluations.csv
Rows / Complete        : 62 / 58
Graph Rows             : 7
...
Run ID                 : replay_score_calibration_20260712_201045_223788
...
Run ID: research_suite_20260712_201045
...
- FORWARD_REGIME_LABELING_READY | known=61 | unknown=2 | injected=0
...
- FORWARD_PROMISING_BACKTEST_CONFLICTS_FOUND | decisions=63 | shadow_signals=23 | eval_shadow=21
...
- MARKET_NARRATIVE_READY | label=MACRO_POLICY_DOMINANT | dir=BEARISH | theme=MACRO_POLICY | score=-7.7124
...
- ROOT_CAUSE_MIXED_WITH_CONTRADICTIONS | primary=MACRO_POLICY_PRESSURE | dir=BEARISH | conf=MEDIUM | p=44.71%
...
==============================================================================================================
Created UTC       : 2026-07-12T20:10:45.605904+00:00
