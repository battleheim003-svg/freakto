...
==============================================================================================================
Created UTC      : 2026-07-18T11:34:31.262312+00:00
...
==============================================================================================================
Created UTC          : 2026-07-18T11:34:31.303557+00:00
...
==============================================================================================================
Created UTC       : 2026-07-18T11:34:31.350685+00:00
...
Scans/Dec/Eval: 66 / 83 / 78
Latest        : NEUTRAL | Rec IGNORE | MTF LONG
Avg Score/Conf/Opp: 36.59 / 31.20% / 14.80
Directional/T1/Avg24: 60.26% / 44.87% / 0.4039%
Paper        : closed 0 | win 0.00% | exp 0.0000R | PF 0.0000
Rec rates    : actionable 0.00% | monitor 4.55% | ignore 33.33%
...
Scans/Dec/Eval: 66 / 0 / 0
Latest        : SHORT | Rec MONITOR | MTF NEUTRAL
Avg Score/Conf/Opp: 39.83 / 34.48% / 14.67
Directional/T1/Avg24: 0.00% / 0.00% / 0.0000%
Paper        : closed 0 | win 0.00% | exp 0.0000R | PF 0.0000
Rec rates    : actionable 0.00% | monitor 7.58% | ignore 30.30%
Note         : نماد در حال رصد است اما هنوز Edge کافی ندارد.
Blocker      : Complete evaluations کمتر از 30 است: 0
Blocker      : Closed paper trades کمتر از 30 است: 0
--------------------------------------------------------------------------------------------------------------
...
Avg Score/Conf/Opp: 38.21 / 32.42% / 18.13
Directional/T1/Avg24: 0.00% / 0.00% / 0.0000%
Paper        : closed 0 | win 0.00% | exp 0.0000R | PF 0.0000
Rec rates    : actionable 0.00% | monitor 6.06% | ignore 31.82%
Note         : نماد در حال رصد است اما هنوز Edge کافی ندارد.
...
Scans/Dec/Eval: 66 / 0 / 0
Latest        : SHORT | Rec MONITOR | MTF NEUTRAL
Avg Score/Conf/Opp: 35.82 / 30.47% / 21.34
Directional/T1/Avg24: 0.00% / 0.00% / 0.0000%
Paper        : closed 0 | win 0.00% | exp 0.0000R | PF 0.0000
Rec rates    : actionable 0.00% | monitor 9.09% | ignore 28.79%
Note         : نماد در حال رصد است اما هنوز Edge کافی ندارد.
Blocker      : Complete evaluations کمتر از 30 است: 0
Blocker      : Closed paper trades کمتر از 30 است: 0
--------------------------------------------------------------------------------------------------------------
...
Avg Score/Conf/Opp: 35.06 / 28.45% / 19.17
Directional/T1/Avg24: 0.00% / 0.00% / 0.0000%
Paper        : closed 0 | win 0.00% | exp 0.0000R | PF 0.0000
Rec rates    : actionable 0.00% | monitor 7.58% | ignore 30.30%
Note         : نماد در حال رصد است اما هنوز Edge کافی ندارد.
...
==============================================================================================================
Created UTC       : 2026-07-18T11:34:31.367581+00:00
...
==============================================================================================================
Created UTC      : 2026-07-18T11:34:31.415492+00:00
...
==============================================================================================================
Status                 : NO_BACKTEST_DATA
Run ID                 : backtest_diag_20260718_113431
Rows / Complete        : 0 / 0
Directional Samples    : 0
Directional Win Rate   : 0.00%
Target 1 Hit Rate      : 0.00%
...
==============================================================================================================
Status                 : NO_BACKTEST_DATA
Run ID                 : gate_sim_20260718_113431
Horizon                : 24h
Min Samples            : 30
Rows / Complete        : 0 / 0
Directional Samples    : 0
...
Run ID                 : forward_regime_label_20260718_113431
Apply Changes          : False
Decision Rows          : 83
Known Before / After   : 61 / 61
Unknown Before / After : 22 / 22
...
Recommendations:
→ هنوز 22 تصمیم Forward بدون regime قابل‌اعتماد مانده؛ اجرای‌های جدید بعد از v6.2.1 باید این عدد را کاهش دهد.
...
Run ID                 : shadow_gate_20260718_113431
Horizon                : 24h
Min Samples            : 30
Decisions              : 83
...
==============================================================================================================
Status: NO_BACKTEST_DATA
Run ID: regime_gate_matrix_20260718_113431
Horizon: 24h
...
Run ID                 : forward_shadow_coverage_20260718_113431
Horizon                : 24h
Decision Rows          : 83
Directional Decisions  : 41
Evaluation Rows        : 82
...
- TRENDING_BULL: rows=52 | directional=35 | share=62.65% | direct=0 | proxy/text=0
- UNKNOWN: rows=22 | directional=5 | share=26.51% | direct=0 | proxy/text=0
- TRENDING_BEAR: rows=8 | directional=1 | share=9.64% | direct=0 | proxy/text=0
- SIDEWAYS: rows=1 | directional=0 | share=1.2% | direct=0 | proxy/text=0
...
Run ID                 : root_cause_20260718_113431
...
- MACRO_POLICY_PRESSURE: p=69.19% | score=87.2689 | dir=BEARISH | evidence=10 | verdict=PRIMARY_PROBABLE_CAUSE
...
Run ID                 : root_cause_forward_20260718_113431
...
- MACRO_POLICY_PRESSURE | BEARISH | n24=27 hit24=74.07% avg24=0.2531% | n12=30 hit12=63.33% | score=18.0136 | ROOT_CAUSE_FORWARD_RESEARCH_CANDIDATE
...
Run ID                 : root_cause_samples_20260718_113431
Evaluations File       : logs/decision_evaluations.csv
Rows / Complete        : 82 / 78
Root Cause Rows        : 31
Evaluated Cells        : 88
...
More decisions needed  : min=0 | research=0 | candidate=1

Root Cause Buckets:
- MACRO_POLICY_PRESSURE | BEARISH | rows=31 cells=88 | n24=27 hit24=74.07% avg24=0.2531% | maturity=RESEARCH_SAMPLE_READY | PROMISING_RESEARCH_WATCHLIST
...
Run ID                 : evidence_graph_20260718_113431
Evaluations File       : logs/decision_evaluations.csv
Rows / Complete        : 82 / 78
Graph Rows             : 27
...
Run ID                 : replay_score_calibration_20260718_113431_678742
...
Run ID: research_suite_20260718_113432
...
- FORWARD_REGIME_LABELING_READY | known=61 | unknown=22 | injected=0
...
- FORWARD_PROMISING_BACKTEST_CONFLICTS_FOUND | decisions=83 | shadow_signals=27 | eval_shadow=26
...
- MARKET_NARRATIVE_READY | label=MACRO_POLICY_DOMINANT | dir=BEARISH | theme=MACRO_POLICY | score=-5.1253
...
- ROOT_CAUSE_PRIMARY_PROBABLE | primary=MACRO_POLICY_PRESSURE | dir=BEARISH | conf=HIGH | p=69.19%
- quality=HIGH | evidence=13 | verdict=PRIMARY_PROBABLE_ROOT_CAUSE

Root Cause Forward Validation:
- ROOT_CAUSE_FORWARD_CANDIDATES_FOUND | rows=31 | cells=88 | candidates=1 | low_sample=0
...
==============================================================================================================
Created UTC       : 2026-07-18T11:34:32.149129+00:00
