...
==============================================================================================================
Created UTC      : 2026-07-10T23:38:32.184679+00:00
...
Expectancy   : 0.7257pct
ProfitFactor : 3.1390
Sharpe-like  : 3.3451 | Sortino-like: 4.5766
Max Drawdown : -12.6696pct
Best/Worst   : 3.8877pct / -3.2625pct
Avg Win/Loss : 1.3927pct / -1.4420pct
Stop Rate    : 45.10%
...
==============================================================================================================
Created UTC          : 2026-07-10T23:38:32.214516+00:00
...
==============================================================================================================
Created UTC       : 2026-07-10T23:38:32.227030+00:00
...
==============================================================================================================
Created UTC       : 2026-07-10T23:38:32.242042+00:00
...
==============================================================================================================
Created UTC      : 2026-07-10T23:38:32.289670+00:00
Risk Quality     : RISK_PROFILE_ACCEPTABLE
Source           : decision_evaluations_fallback (pct)
Samples          : 51
Iterations       : 2000
Trades / Run     : 100
Expected / Trade : 0.7257pct
Best / Worst Samp: 3.8877pct / -3.2625pct
--------------------------------------------------------------------------------------------------------------
Median Final     : 72.7090pct
Mean Final       : 73.0047pct
P05 / P95 Final  : 46.6751pct / 98.6843pct
...
==============================================================================================================
Status                 : NO_BACKTEST_DATA
Run ID                 : backtest_diag_20260710_233832
Rows / Complete        : 0 / 0
Directional Samples    : 0
Directional Win Rate   : 0.00%
Target 1 Hit Rate      : 0.00%
...
==============================================================================================================
Status                 : NO_BACKTEST_DATA
Run ID                 : gate_sim_20260710_233832
Horizon                : 24h
Min Samples            : 30
Rows / Complete        : 0 / 0
Directional Samples    : 0
...
Run ID                 : forward_regime_label_20260710_233832
Apply Changes          : False
Decision Rows          : 54
...
Run ID                 : shadow_gate_20260710_233832
Horizon                : 24h
Min Samples            : 30
Decisions              : 54
...
- HISTORICAL_EDGE_SCORE_GE_1 [SHADOW_BUILDING]: signals=4 | eval=2 | pending=0 | avg=-3.0511% | win=0.0% | T1=100.0% | Stop=100.0% | MFE/MAE=0.317 | warn=Forward evaluated samples کمتر از حداقل 30 است: 2
...
==============================================================================================================
Status: NO_BACKTEST_DATA
Run ID: regime_gate_matrix_20260710_233832
Horizon: 24h
...
Run ID                 : forward_shadow_coverage_20260710_233832
Horizon                : 24h
Decision Rows          : 54
Directional Decisions  : 30
Evaluation Rows        : 53
...
- TRENDING_BULL: rows=45 | directional=29 | share=83.33% | direct=0 | proxy/text=0
- TRENDING_BEAR: rows=8 | directional=1 | share=14.81% | direct=0 | proxy/text=0
- SIDEWAYS: rows=1 | directional=0 | share=1.85% | direct=0 | proxy/text=0
...
Run ID                 : root_cause_20260710_233832
Symbol / TF            : BTC/USDT | 4h
Lookback Hours         : 168
Decision Side/Score    : NEUTRAL | 35
...
- Direction            : BEARISH
- Confidence           : MEDIUM
- Probability Share    : 42.35%
- Evidence Quality     : HIGH
- Verdict              : PROBABLE_CAUSE_BUT_CONFLICTED
- Summary              : Probable root cause=MACRO_POLICY_PRESSURE; direction=BEARISH; confidence=MEDIUM; share=42.35%. قوی‌ترین evidence از federal_reserve_press است: Market narrative theme: MACRO_POLICY | هشدار: شواهد متضاد همزمان وجود دارد.
- Evidence Total       : 16 | official=12 | event_rows=12

Top Cause Hypotheses:
- MACRO_POLICY_PRESSURE: p=42.35% | score=68.3793 | dir=BEARISH | evidence=7 | verdict=SUPPORTING_CAUSE
- REGULATORY_ACCESS_OR_MODERNIZATION: p=13.37% | score=21.59 | dir=BULLISH | evidence=2 | verdict=WEAK_SUPPORTING_CAUSE
- MIXED_EVENT_CONFLICT: p=13.17% | score=21.272 | dir=MIXED_OR_NEUTRAL | evidence=2 | verdict=WEAK_SUPPORTING_CAUSE
- EXCHANGE_MARKET_ACCESS: p=11.75% | score=18.975 | dir=MIXED_OR_NEUTRAL | evidence=2 | verdict=WEAK_SUPPORTING_CAUSE
- TECHNICAL_STRUCTURE_MOMENTUM: p=10.31% | score=16.65 | dir=MIXED_OR_NEUTRAL | evidence=1 | verdict=WEAK_SUPPORTING_CAUSE
- REGULATORY_RISK: p=9.05% | score=14.615 | dir=BEARISH | evidence=2 | verdict=WEAK_SUPPORTING_CAUSE

Contradictions:
⚠️ شواهد bullish و bearish همزمان قوی‌اند: bull=21.59, bear=82.99
...
Run ID                 : root_cause_samples_20260710_233832
Evaluations File       : logs/decision_evaluations.csv
Rows / Complete        : 53 / 51
Root Cause Rows        : 2
Evaluated Cells        : 3
...
Root Cause Buckets:
- MACRO_POLICY_PRESSURE | BEARISH | rows=2 cells=3 | n24=0 hit24=0.0% avg24=0.0% | maturity=LOW_SAMPLE_ACCUMULATING | LOW_SAMPLE_KEEP_COLLECTING
...
Run ID                 : evidence_graph_20260710_233832
Evaluations File       : logs/decision_evaluations.csv
Rows / Complete        : 53 / 51
Graph Rows             : 0
...
Run ID: research_suite_20260710_233832
...
- MARKET_NARRATIVE_WITH_CONFLICTS | label=MIXED_NARRATIVE_CONFLICT | dir=BEARISH | theme=MACRO_POLICY | score=-21.7975
...
==============================================================================================================
Created UTC       : 2026-07-10T23:38:32.917374+00:00
