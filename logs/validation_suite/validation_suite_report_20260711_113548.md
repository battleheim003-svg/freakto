...
==============================================================================================================
Created UTC      : 2026-07-11T11:35:47.805312+00:00
...
Expectancy   : 0.7040pct
ProfitFactor : 3.0748
Sharpe-like  : 3.2949 | Sortino-like: 4.5069
Max Drawdown : -12.6696pct
Best/Worst   : 3.8877pct / -3.2625pct
Avg Win/Loss : 1.3911pct / -1.3573pct
Stop Rate    : 44.23%
...
==============================================================================================================
Created UTC          : 2026-07-11T11:35:47.838177+00:00
...
==============================================================================================================
Created UTC       : 2026-07-11T11:35:47.852826+00:00
...
==============================================================================================================
Created UTC       : 2026-07-11T11:35:47.869228+00:00
...
==============================================================================================================
Created UTC      : 2026-07-11T11:35:47.919425+00:00
Risk Quality     : RISK_PROFILE_ACCEPTABLE
Source           : decision_evaluations_fallback (pct)
Samples          : 52
Iterations       : 2000
Trades / Run     : 100
Expected / Trade : 0.7040pct
Best / Worst Samp: 3.8877pct / -3.2625pct
--------------------------------------------------------------------------------------------------------------
Median Final     : 70.4772pct
Mean Final       : 70.5100pct
P05 / P95 Final  : 44.2932pct / 95.1223pct
Median Max DD    : -5.9837pct
P95 Max DD       : -10.6545pct
Prob Loss        : 0.00%
...
==============================================================================================================
Status                 : NO_BACKTEST_DATA
Run ID                 : backtest_diag_20260711_113547
Rows / Complete        : 0 / 0
Directional Samples    : 0
Directional Win Rate   : 0.00%
Target 1 Hit Rate      : 0.00%
...
==============================================================================================================
Status                 : NO_BACKTEST_DATA
Run ID                 : gate_sim_20260711_113547
Horizon                : 24h
Min Samples            : 30
Rows / Complete        : 0 / 0
Directional Samples    : 0
...
Run ID                 : forward_regime_label_20260711_113547
Apply Changes          : False
Decision Rows          : 56
...
Run ID                 : shadow_gate_20260711_113547
Horizon                : 24h
Min Samples            : 30
Decisions              : 56
Directional Decisions  : 32
Gates Tracked          : 11
Shadow Signals         : 20
Evaluated Shadow       : 17
Pending Shadow         : 0
...
- HISTORICAL_EDGE_SCORE_GE_1 [SHADOW_BUILDING]: signals=5 | eval=3 | pending=0 | avg=-2.1477% | win=0.0% | T1=66.67% | Stop=66.67% | MFE/MAE=0.322 | warn=Forward evaluated samples کمتر از حداقل 30 است: 3
...
==============================================================================================================
Status: NO_BACKTEST_DATA
Run ID: regime_gate_matrix_20260711_113548
Horizon: 24h
...
Run ID                 : forward_shadow_coverage_20260711_113548
Horizon                : 24h
Decision Rows          : 56
Directional Decisions  : 32
Evaluation Rows        : 55
...
- TRENDING_BULL: rows=47 | directional=31 | share=83.93% | direct=0 | proxy/text=0
- TRENDING_BEAR: rows=8 | directional=1 | share=14.29% | direct=0 | proxy/text=0
- SIDEWAYS: rows=1 | directional=0 | share=1.79% | direct=0 | proxy/text=0

Shadow Gate Coverage:
- STRUCTURE_SCORE_GE_10: signals=14 | eval=14 | avg=0.8834% | win=100.0% | dominant_regime=TRENDING_BULL
- HISTORICAL_EDGE_SCORE_GE_1: signals=5 | eval=3 | avg=-2.1477% | win=0.0% | dominant_regime=TRENDING_BULL
...
Run ID                 : root_cause_20260711_113548
...
Run ID                 : root_cause_forward_20260711_113548
...
Run ID                 : root_cause_samples_20260711_113548
Evaluations File       : logs/decision_evaluations.csv
Rows / Complete        : 55 / 52
Root Cause Rows        : 4
Evaluated Cells        : 8
...
Run ID                 : evidence_graph_20260711_113548
Evaluations File       : logs/decision_evaluations.csv
Rows / Complete        : 55 / 52
Graph Rows             : 1
...
Top Evidence Paths:
- EVIDENCE_SOURCE:FEDERAL_RESERVE_PRESS -> ROOT_CAUSE:MACRO_POLICY_PRESSURE_BEARISH -> OUTCOME:ROOT_CAUSE_HIT_24H | n=1 hit24=100.0% avg24=0.3409% | LOW_SAMPLE_EDGE
- EVIDENCE_SOURCE:MANUAL_EVENTS -> ROOT_CAUSE:MACRO_POLICY_PRESSURE_BEARISH -> OUTCOME:ROOT_CAUSE_HIT_24H | n=1 hit24=100.0% avg24=0.3409% | LOW_SAMPLE_EDGE
- EVIDENCE_SOURCE:AUTO_EVENTS -> ROOT_CAUSE:MACRO_POLICY_PRESSURE_BEARISH -> OUTCOME:ROOT_CAUSE_HIT_24H | n=1 hit24=100.0% avg24=0.3409% | LOW_SAMPLE_EDGE

Root Cause Learning Signals:
- MACRO_POLICY_PRESSURE | BEARISH | n24=1 hit24=100.0% avg24=0.3409% | LOW_SAMPLE_DO_NOT_RETUNE
...
Run ID: research_suite_20260711_113548
...
- FORWARD_REGIME_LABELING_READY | known=56 | unknown=0 | injected=0
...
- FORWARD_PROMISING_BACKTEST_CONFLICTS_FOUND | decisions=56 | shadow_signals=20 | eval_shadow=17
...
- MARKET_NARRATIVE_WITH_CONFLICTS | label=MIXED_NARRATIVE_CONFLICT | dir=BEARISH | theme=MACRO_POLICY | score=-20.3002
...
- ROOT_CAUSE_MIXED_WITH_CONTRADICTIONS | primary=MACRO_POLICY_PRESSURE | dir=BEARISH | conf=MEDIUM | p=42.23%
- quality=HIGH | evidence=16 | verdict=PROBABLE_CAUSE_BUT_CONFLICTED

Root Cause Forward Validation:
- ROOT_CAUSE_FORWARD_PROMISING_LOW_SAMPLE | rows=4 | cells=8 | candidates=0 | low_sample=1
- MACRO_POLICY_PRESSURE BEARISH: n24=1 hit24=100.0% avg24=0.3409% | FORWARD_PROMISING_LOW_SAMPLE
...
⛔ root_cause_sample_tracker: Root Cause evaluated cells کمتر از حداقل است: 8/10
...
==============================================================================================================
Created UTC       : 2026-07-11T11:35:48.621217+00:00
...
Note      : Directional Win 75.00% | Expectancy 0.7040pct | PF 3.0748
Note      : Stop 44.23% | Sharpe-like 3.2949
