...
==============================================================================================================
Created UTC      : 2026-07-20T08:26:49.279389+00:00
...
==============================================================================================================
Created UTC          : 2026-07-20T08:26:49.319867+00:00
...
==============================================================================================================
Created UTC       : 2026-07-20T08:26:49.367114+00:00
...
Scans/Dec/Eval: 74 / 91 / 88
Latest        : NEUTRAL | Rec IGNORE | MTF NEUTRAL
Avg Score/Conf/Opp: 37.39 / 31.65% / 15.28
...
Avg Score/Conf/Opp: 38.42 / 33.53% / 13.96
Directional/T1/Avg24: 0.00% / 0.00% / 0.0000%
Paper        : closed 0 | win 0.00% | exp 0.0000R | PF 0.0000
Rec rates    : actionable 0.00% | monitor 8.11% | ignore 36.49%
Note         : نماد در حال رصد است اما هنوز Edge کافی ندارد.
Blocker      : Complete evaluations کمتر از 30 است: 0
Blocker      : Closed paper trades کمتر از 30 است: 0
--------------------------------------------------------------------------------------------------------------
...
Avg Score/Conf/Opp: 37.22 / 31.39% / 14.30
Directional/T1/Avg24: 0.00% / 0.00% / 0.0000%
Paper        : closed 0 | win 0.00% | exp 0.0000R | PF 0.0000
Rec rates    : actionable 0.00% | monitor 5.41% | ignore 39.19%
Note         : نماد در حال رصد است اما هنوز Edge کافی ندارد.
...
Avg Score/Conf/Opp: 34.91 / 29.68% / 18.18
Directional/T1/Avg24: 0.00% / 0.00% / 0.0000%
Paper        : closed 0 | win 0.00% | exp 0.0000R | PF 0.0000
Rec rates    : actionable 0.00% | monitor 8.11% | ignore 36.49%
Note         : نماد در حال رصد است اما هنوز Edge کافی ندارد.
...
Scans/Dec/Eval: 74 / 0 / 0
Latest        : NEUTRAL | Rec IGNORE | MTF NEUTRAL
Avg Score/Conf/Opp: 33.78 / 27.59% / 14.86
Directional/T1/Avg24: 0.00% / 0.00% / 0.0000%
Paper        : closed 0 | win 0.00% | exp 0.0000R | PF 0.0000
Rec rates    : actionable 0.00% | monitor 6.76% | ignore 37.84%
Note         : نماد در حال رصد است اما هنوز Edge کافی ندارد.
Blocker      : Complete evaluations کمتر از 30 است: 0
Blocker      : Closed paper trades کمتر از 30 است: 0
==============================================================================================================
...
==============================================================================================================
Created UTC       : 2026-07-20T08:26:49.383524+00:00
...
==============================================================================================================
Created UTC      : 2026-07-20T08:26:49.431402+00:00
...
==============================================================================================================
Status                 : NO_BACKTEST_DATA
Run ID                 : backtest_diag_20260720_082649
Rows / Complete        : 0 / 0
Directional Samples    : 0
Directional Win Rate   : 0.00%
Target 1 Hit Rate      : 0.00%
...
==============================================================================================================
Status                 : NO_BACKTEST_DATA
Run ID                 : gate_sim_20260720_082649
Horizon                : 24h
Min Samples            : 30
Rows / Complete        : 0 / 0
Directional Samples    : 0
...
Run ID                 : forward_regime_label_20260720_082649
Apply Changes          : False
Decision Rows          : 91
...
Run ID                 : shadow_gate_20260720_082649
Horizon                : 24h
Min Samples            : 30
Decisions              : 91
...
==============================================================================================================
Status: NO_BACKTEST_DATA
Run ID: regime_gate_matrix_20260720_082649
Horizon: 24h
...
Run ID                 : forward_shadow_coverage_20260720_082649
Horizon                : 24h
Decision Rows          : 91
Directional Decisions  : 42
Evaluation Rows        : 90
...
- TRENDING_BULL: rows=52 | directional=35 | share=57.14% | direct=0 | proxy/text=0
- UNKNOWN: rows=30 | directional=6 | share=32.97% | direct=0 | proxy/text=0
- TRENDING_BEAR: rows=8 | directional=1 | share=8.79% | direct=0 | proxy/text=0
- SIDEWAYS: rows=1 | directional=0 | share=1.1% | direct=0 | proxy/text=0
...
Run ID                 : root_cause_20260720_082649
...
- Direction            : BEARISH
- Confidence           : HIGH
- Probability Share    : 69.83%
- Evidence Quality     : HIGH
- Verdict              : PRIMARY_PROBABLE_ROOT_CAUSE
- Summary              : Probable root cause=MACRO_POLICY_PRESSURE; direction=BEARISH; confidence=HIGH; share=69.83%. قوی‌ترین evidence از federal_reserve_speeches است: Market narrative theme: MACRO_POLICY
- Evidence Total       : 13 | official=10 | event_rows=10

Top Cause Hypotheses:
- MACRO_POLICY_PRESSURE: p=69.83% | score=77.6484 | dir=BEARISH | evidence=10 | verdict=PRIMARY_PROBABLE_CAUSE
- TECHNICAL_STRUCTURE_MOMENTUM: p=16.19% | score=18.0 | dir=MIXED_OR_NEUTRAL | evidence=1 | verdict=WEAK_SUPPORTING_CAUSE
- EXCHANGE_MARKET_ACCESS: p=8.13% | score=9.035 | dir=BULLISH | evidence=1 | verdict=WEAK_SUPPORTING_CAUSE
- MIXED_EVENT_CONFLICT: p=5.85% | score=6.51 | dir=MIXED_OR_NEUTRAL | evidence=1 | verdict=WEAK_SUPPORTING_CAUSE
...
Run ID                 : root_cause_forward_20260720_082649
...
Run ID                 : root_cause_samples_20260720_082649
Evaluations File       : logs/decision_evaluations.csv
Rows / Complete        : 90 / 88
Root Cause Rows        : 39
Evaluated Cells        : 115
...
Run ID                 : evidence_graph_20260720_082649
Evaluations File       : logs/decision_evaluations.csv
Rows / Complete        : 90 / 88
Graph Rows             : 37
...
Run ID                 : replay_score_calibration_20260720_082649_697961
...
Run ID: research_suite_20260720_082650
...
- FORWARD_REGIME_LABELING_READY | known=61 | unknown=30 | injected=0
...
- FORWARD_PROMISING_BACKTEST_CONFLICTS_FOUND | decisions=91 | shadow_signals=28 | eval_shadow=28
...
- MARKET_NARRATIVE_READY | label=MACRO_POLICY_DOMINANT | dir=BEARISH | theme=MACRO_POLICY | score=-3.924
...
- ROOT_CAUSE_PRIMARY_PROBABLE | primary=MACRO_POLICY_PRESSURE | dir=BEARISH | conf=HIGH | p=69.83%
...
==============================================================================================================
Created UTC       : 2026-07-20T08:26:50.178951+00:00
