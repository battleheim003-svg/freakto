...
- The pre-trade cost gate retained 816 event rows (22.74%).
- The fixed no-trade baseline has zero expectancy and zero drawdown; every tradable candidate must beat it after costs.
- Meta-label Holdout selected n=45, expectancy=3.031538% and PF=2.3170923995626524.
- Walk-forward positive-fold fraction was 50.00%.
