...
- Samples: 54
- Overall Directional Win: 75.93%
- Overall Target 1 Hit: 48.15%
- Mean Calibration Error: 31.61 pts
...
- **Low**: n=30, predicted=25.0%, directional=73.33%, T1=13.33%, gap=+48.33, verdict=UNDER_CONFIDENT
...
- **score_30_39**: n=15, predicted=34.5%, directional=73.33%, T1=0.00%, gap=+38.83, verdict=UNDER_CONFIDENT
