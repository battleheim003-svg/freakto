...
- Samples: 117
- Overall Directional Win: 62.39%
- Overall Target 1 Hit: 29.91%
- Mean Calibration Error: 22.43 pts
...
- **nan**: n=56, predicted=50.0%, directional=58.93%, T1=0.00%, gap=+8.93, verdict=WELL_CALIBRATED_DIRECTIONAL
...
- **score_30_39**: n=29, predicted=34.5%, directional=65.52%, T1=0.00%, gap=+31.02, verdict=UNDER_CONFIDENT
