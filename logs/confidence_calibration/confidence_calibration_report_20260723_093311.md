...
- Samples: 98
- Overall Directional Win: 61.22%
- Overall Target 1 Hit: 35.71%
- Mean Calibration Error: 20.30 pts
...
- **nan**: n=37, predicted=50.0%, directional=54.05%, T1=0.00%, gap=+4.05, verdict=WELL_CALIBRATED_DIRECTIONAL
...
- **score_50_59**: n=12, predicted=54.5%, directional=83.33%, T1=58.33%, gap=+28.83, verdict=UNDER_CONFIDENT
- **score_60_69**: n=16, predicted=64.5%, directional=43.75%, T1=75.00%, gap=-20.75, verdict=OVER_CONFIDENT
