...
- Samples: 68
- Overall Directional Win: 64.71%
- Overall Target 1 Hit: 50.00%
- Mean Calibration Error: 21.09 pts
...
- **nan**: n=7, predicted=50.0%, directional=57.14%, T1=0.00%, gap=+7.14, verdict=LOW_SAMPLE
- **Medium**: n=17, predicted=55.0%, directional=64.71%, T1=100.00%, gap=+9.71, verdict=WELL_CALIBRATED_DIRECTIONAL
- **Medium-High**: n=11, predicted=67.5%, directional=72.73%, T1=90.91%, gap=+5.23, verdict=WELL_CALIBRATED_DIRECTIONAL
...
- **score_30_39**: n=19, predicted=34.5%, directional=57.89%, T1=0.00%, gap=+23.39, verdict=UNDER_CONFIDENT
...
- **score_70_79**: n=11, predicted=74.5%, directional=72.73%, T1=90.91%, gap=-1.77, verdict=WELL_CALIBRATED_DIRECTIONAL