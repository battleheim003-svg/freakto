...
- Samples: 106
- Overall Directional Win: 60.38%
- Overall Target 1 Hit: 33.02%
- Mean Calibration Error: 19.95 pts
...
- **nan**: n=45, predicted=50.0%, directional=53.33%, T1=0.00%, gap=+3.33, verdict=WELL_CALIBRATED_DIRECTIONAL
...
- **score_40_49**: n=17, predicted=44.5%, directional=58.82%, T1=29.41%, gap=+14.32, verdict=UNDER_CONFIDENT
