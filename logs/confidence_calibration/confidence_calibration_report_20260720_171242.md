...
- Samples: 89
- Overall Directional Win: 61.80%
- Overall Target 1 Hit: 39.33%
- Mean Calibration Error: 19.56 pts
...
- **nan**: n=28, predicted=50.0%, directional=53.57%, T1=0.00%, gap=+3.57, verdict=WELL_CALIBRATED_DIRECTIONAL
...
- **score_30_39**: n=24, predicted=34.5%, directional=62.50%, T1=0.00%, gap=+28.00, verdict=UNDER_CONFIDENT
- **score_40_49**: n=13, predicted=44.5%, directional=46.15%, T1=38.46%, gap=+1.65, verdict=WELL_CALIBRATED_DIRECTIONAL
