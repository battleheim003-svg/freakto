...
- Samples: 113
- Overall Directional Win: 62.83%
- Overall Target 1 Hit: 30.97%
- Mean Calibration Error: 22.34 pts
...
- **nan**: n=52, predicted=50.0%, directional=59.62%, T1=0.00%, gap=+9.62, verdict=WELL_CALIBRATED_DIRECTIONAL
...
- **score_20_29**: n=15, predicted=24.5%, directional=66.67%, T1=0.00%, gap=+42.17, verdict=UNDER_CONFIDENT
