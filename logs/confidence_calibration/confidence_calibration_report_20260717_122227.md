...
- Samples: 75
- Overall Directional Win: 61.33%
- Overall Target 1 Hit: 46.67%
- Mean Calibration Error: 19.97 pts
...
- **nan**: n=14, predicted=50.0%, directional=42.86%, T1=0.00%, gap=-7.14, verdict=WELL_CALIBRATED_DIRECTIONAL
...
- **score_20_29**: n=8, predicted=24.5%, directional=62.50%, T1=0.00%, gap=+38.00, verdict=LOW_SAMPLE
- **score_30_39**: n=21, predicted=34.5%, directional=57.14%, T1=0.00%, gap=+22.64, verdict=UNDER_CONFIDENT
