...
- Samples: 62
- Overall Directional Win: 64.52%
- Overall Target 1 Hit: 41.94%
- Mean Calibration Error: 22.09 pts
...
- **nan**: n=1, predicted=50.0%, directional=0.00%, T1=0.00%, gap=-50.00, verdict=LOW_SAMPLE
...
- **score_30_39**: n=16, predicted=34.5%, directional=62.50%, T1=0.00%, gap=+28.00, verdict=UNDER_CONFIDENT
