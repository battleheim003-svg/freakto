...
Run ID                 : market_narrative_20260715_201950
...
- Net Direction Score  : -4.4892
- Event Risk           : HIGH
- Tech/Event Conflict  : HIGH
- Summary              : Narrative=MIXED_NARRATIVE_CONFLICT; direction=BEARISH; theme=MACRO_POLICY; net_score=-4.4892; risk=HIGH. محرک اصلی فعلی از federal_reserve_speeches است: Bowman, Modernizing Financial Regulation
...
Theme Scores:
- MACRO_POLICY: score=-4.4892 | drivers=2 | bull=0 | bear=2

Top Narrative Drivers:
- BEARISH | w=-2.8344 | MACRO_POLICY | federal_reserve_speeches | Bowman, Modernizing Financial Regulation
