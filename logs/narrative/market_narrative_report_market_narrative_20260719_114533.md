...
Run ID                 : market_narrative_20260719_114533
...
- Net Direction Score  : -4.4381
- Event Risk           : HIGH
- Tech/Event Conflict  : HIGH
- Summary              : Narrative=MIXED_NARRATIVE_CONFLICT; direction=BEARISH; theme=MACRO_POLICY; net_score=-4.4381; risk=HIGH. محرک اصلی فعلی از federal_reserve_press است: Agencies issue joint statement on handling of highly sensitive information during bank examinations
...
- Competing theme: REGULATORY_RISK score=2.6407
...
Theme Scores:
- MACRO_POLICY: score=-7.0788 | drivers=3 | bull=0 | bear=3
- REGULATORY_RISK: score=2.6407 | drivers=1 | bull=1 | bear=0

Top Narrative Drivers:
- BEARISH | w=-2.7213 | MACRO_POLICY | federal_reserve_press | Agencies issue joint statement on handling of highly sensitive information during bank examinations
- BEARISH | w=-2.6731 | MACRO_POLICY | federal_reserve_press | Federal Reserve Board issues enforcement action with former chief lending officer of Heritage State Bank
- BULLISH | w=2.6407 | REGULATORY_RISK | sec_press_releases | SEC Proposes New E-Delivery Approach to Make Information More Readily Accessible and Useful for Investors
- BEARISH | w=-1.6844 | MACRO_POLICY | federal_reserve_speeches | Bowman, Modernizing Financial Regulation
