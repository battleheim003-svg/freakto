...
Run ID                 : market_narrative_20260713_182344
...
- Net Direction Score  : -7.4632
- Event Risk           : HIGH
- Tech/Event Conflict  : LOW
- Summary              : Narrative=MACRO_POLICY_DOMINANT; direction=BEARISH; theme=MACRO_POLICY; net_score=-7.4632; risk=HIGH. محرک اصلی فعلی از federal_reserve_speeches است: Bowman, Modernizing Financial Regulation
...
Theme Scores:
- MACRO_POLICY: score=-7.7573 | drivers=3 | bull=0 | bear=3
- REGULATORY_RISK: score=0.2941 | drivers=2 | bull=1 | bear=1

Top Narrative Drivers:
- BEARISH | w=-3.8155 | MACRO_POLICY | federal_reserve_speeches | Bowman, Modernizing Financial Regulation
- BEARISH | w=-2.2275 | MACRO_POLICY | federal_reserve_press | Federal Reserve Board issues enforcement action with TS Banking Group, Inc. and TS Contrarian Bancshares, Inc.
- BULLISH | w=1.9647 | REGULATORY_RISK | sec_press_releases | SEC to Host Virtual Roundtable on Modernizing IPOs and Expanding Access to Public Markets
...
- BEARISH | w=-1.6706 | REGULATORY_RISK | sec_press_releases | SEC Forms New Retail Fraud Working Group
