...
Run ID                 : market_narrative_20260715_073258
...
- Net Direction Score  : -3.2692
- Event Risk           : HIGH
- Tech/Event Conflict  : LOW
- Summary              : Narrative=MACRO_POLICY_DOMINANT; direction=BEARISH; theme=MACRO_POLICY; net_score=-3.2692; risk=HIGH. محرک اصلی فعلی از federal_reserve_speeches است: Bowman, Modernizing Financial Regulation
...
- Competing theme: REGULATORY_RISK score=1.5749
...
Theme Scores:
- MACRO_POLICY: score=-4.8441 | drivers=2 | bull=0 | bear=2
- REGULATORY_RISK: score=1.5749 | drivers=1 | bull=1 | bear=0

Top Narrative Drivers:
- BEARISH | w=-3.0585 | MACRO_POLICY | federal_reserve_speeches | Bowman, Modernizing Financial Regulation
- BEARISH | w=-1.7856 | MACRO_POLICY | federal_reserve_press | Federal Reserve Board issues enforcement action with TS Banking Group, Inc. and TS Contrarian Bancshares, Inc.
- BULLISH | w=1.5749 | REGULATORY_RISK | sec_press_releases | SEC to Host Virtual Roundtable on Modernizing IPOs and Expanding Access to Public Markets
