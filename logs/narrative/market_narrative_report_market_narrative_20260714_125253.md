...
Run ID                 : market_narrative_20260714_125253
...
- Net Direction Score  : -6.6855
- Event Risk           : HIGH
- Tech/Event Conflict  : LOW
- Summary              : Narrative=MACRO_POLICY_DOMINANT; direction=BEARISH; theme=MACRO_POLICY; net_score=-6.6855; risk=HIGH. محرک اصلی فعلی از federal_reserve_speeches است: Bowman, Modernizing Financial Regulation
...
Theme Scores:
- MACRO_POLICY: score=-6.949 | drivers=3 | bull=0 | bear=3
- REGULATORY_RISK: score=0.2635 | drivers=2 | bull=1 | bear=1

Top Narrative Drivers:
- BEARISH | w=-3.418 | MACRO_POLICY | federal_reserve_speeches | Bowman, Modernizing Financial Regulation
- BEARISH | w=-1.9954 | MACRO_POLICY | federal_reserve_press | Federal Reserve Board issues enforcement action with TS Banking Group, Inc. and TS Contrarian Bancshares, Inc.
- BULLISH | w=1.76 | REGULATORY_RISK | sec_press_releases | SEC to Host Virtual Roundtable on Modernizing IPOs and Expanding Access to Public Markets
- BEARISH | w=-1.5356 | MACRO_POLICY | federal_reserve_press | Federal Reserve Board requests comment on a proposal to amend its requirements for banks to maintain anti-money laundering programs
- BEARISH | w=-1.4965 | REGULATORY_RISK | sec_press_releases | SEC Forms New Retail Fraud Working Group
