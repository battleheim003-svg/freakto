...
Run ID                 : market_narrative_20260725_201550
...
- Net Direction Score  : 0.4102
- Event Risk           : HIGH
- Tech/Event Conflict  : LOW
- Summary              : Narrative=EVENT_CONTEXT_DOMINANT; direction=MIXED_OR_NEUTRAL; theme=REGULATORY_RISK; net_score=0.4102; risk=HIGH. محرک اصلی فعلی از sec_press_releases است: SEC Announces Roundtable on Preparations for 24-Hour Trading
...
Theme Scores:
- REGULATORY_RISK: score=0.4102 | drivers=2 | bull=1 | bear=1

Top Narrative Drivers:
- BULLISH | w=2.9326 | REGULATORY_RISK | sec_press_releases | SEC Announces Roundtable on Preparations for 24-Hour Trading
- BEARISH | w=-2.5224 | REGULATORY_RISK | sec_press_releases | SEC Announces Departure of Principal Deputy Director of Enforcement Sam Waldon
