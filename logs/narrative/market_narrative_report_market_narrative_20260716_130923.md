...
Run ID                 : market_narrative_20260716_130923
...
- Competing theme: REGULATORY_RISK score=4.0201
...
Theme Scores:
- MACRO_POLICY: score=-4.0614 | drivers=2 | bull=0 | bear=2
- REGULATORY_RISK: score=4.0201 | drivers=1 | bull=1 | bear=0

Top Narrative Drivers:
- BULLISH | w=4.0201 | REGULATORY_RISK | sec_press_releases | SEC Proposes New E-Delivery Approach to Make Information More Readily Accessible and Useful for Investors
- BEARISH | w=-2.5643 | MACRO_POLICY | federal_reserve_speeches | Bowman, Modernizing Financial Regulation
