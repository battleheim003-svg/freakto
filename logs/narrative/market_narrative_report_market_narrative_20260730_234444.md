...
Run ID                 : market_narrative_20260730_234444
...
- Net Direction Score  : -7.6416
- Event Risk           : HIGH
- Tech/Event Conflict  : LOW
- Summary              : Narrative=MACRO_POLICY_DOMINANT; direction=BEARISH; theme=MACRO_POLICY; net_score=-7.6416; risk=HIGH. محرک اصلی فعلی از federal_reserve_press است: Federal Reserve Board issues enforcement actions with former employee of Regions Bank and former employee of First Inter
...
Theme Scores:
- MACRO_POLICY: score=-7.6416 | drivers=2 | bull=0 | bear=2

Top Narrative Drivers:
- BEARISH | w=-3.8208 | MACRO_POLICY | federal_reserve_press | Federal Reserve Board issues enforcement actions with former employee of Regions Bank and former employee of First Interstate Bank
- BEARISH | w=-3.8208 | MACRO_POLICY | federal_reserve_press | Federal Reserve Board issues enforcement action with Iuka Bancshares, Inc. and The Iuka State Bank
