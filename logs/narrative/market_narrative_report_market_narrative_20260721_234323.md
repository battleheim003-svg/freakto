...
Run ID                 : market_narrative_20260721_234323
...
- Net Direction Score  : -1.9271
- Event Risk           : HIGH
- Tech/Event Conflict  : LOW
- Summary              : Narrative=MACRO_POLICY_DOMINANT; direction=MIXED_OR_NEUTRAL; theme=MACRO_POLICY; net_score=-1.9271; risk=HIGH. محرک اصلی فعلی از federal_reserve_press است: Agencies issue joint statement on handling of highly sensitive information during bank examinations
...
- Competing theme: REGULATORY_RISK score=1.848
...
Theme Scores:
- MACRO_POLICY: score=-3.7751 | drivers=2 | bull=0 | bear=2
- REGULATORY_RISK: score=1.848 | drivers=1 | bull=1 | bear=0

Top Narrative Drivers:
- BEARISH | w=-1.9044 | MACRO_POLICY | federal_reserve_press | Agencies issue joint statement on handling of highly sensitive information during bank examinations
- BEARISH | w=-1.8707 | MACRO_POLICY | federal_reserve_press | Federal Reserve Board issues enforcement action with former chief lending officer of Heritage State Bank
- BULLISH | w=1.848 | REGULATORY_RISK | sec_press_releases | SEC Proposes New E-Delivery Approach to Make Information More Readily Accessible and Useful for Investors
