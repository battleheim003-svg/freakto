...
- generated_utc: `2026-07-15T07:32:30.581656+00:00`
- horizon: `24h`
- min_samples: `30`
- decisions: `71`
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| STRUCTURE_SCORE_GE_10 | SHADOW_BUILDING | 15 | 15 | 0 | 0.8707% | 100.0% | 93.33% | 80.0% | 1.941 | مثبت ولی نیازمند review: structure_score >= 10. |
| HISTORICAL_EDGE_SCORE_GE_1 | SHADOW_BUILDING | 8 | 8 | 0 | -1.2246% | 12.5% | 87.5% | 100.0% | 0.442 | Backtest candidate با stop کمتر: historical_edge_score >= 1. |
| RISK_MEDIUM | SHADOW_BUILDING | 1 | 1 | 0 | 0.5361% | 100.0% | 100.0% | 100.0% | 0.557 | Backtest candidate با sample بیشتر: risk_label = Medium. |
