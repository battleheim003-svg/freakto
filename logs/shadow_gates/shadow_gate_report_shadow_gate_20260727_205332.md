...
- generated_utc: `2026-07-27T20:53:32.235458+00:00`
- horizon: `24h`
- min_samples: `30`
- decisions: `117`
- directional_decisions: `51`
- gates_tracked: `11`
- shadow_signals: `38`
- evaluated_shadow_samples: `37`
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| STRUCTURE_SCORE_GE_10 | SHADOW_BUILDING | 28 | 27 | 1 | 0.3783% | 70.37% | 51.85% | 44.44% | 1.884 | مثبت ولی نیازمند review: structure_score >= 10. |
...
| SCORE_GE_80 | SHADOW_BUILDING | 1 | 1 | 0 | -0.1356% | 0.0% | 0.0% | 0.0% | 0.179 | مثبت کم‌نمونه: score >= 80؛ فقط watchlist تحقیقاتی. |
...
| STRUCTURE_SCORE_GE_10 | PENDING | BTC/USDT | LONG | 75 |  | 2026-07-27 16:00:00 |
