...
Run ID                 : root_cause_20260711_072705
...
- MACRO_POLICY_PRESSURE: p=41.81% | score=68.0326 | dir=BEARISH | evidence=7 | verdict=SUPPORTING_CAUSE
- REGULATORY_ACCESS_OR_MODERNIZATION: p=13.27% | score=21.59 | dir=BULLISH | evidence=2 | verdict=WEAK_SUPPORTING_CAUSE
- MIXED_EVENT_CONFLICT: p=13.21% | score=21.492 | dir=MIXED_OR_NEUTRAL | evidence=2 | verdict=WEAK_SUPPORTING_CAUSE
...
- MACRO_POLICY_PRESSURE | BEARISH | w=16.2826 | market_narrative | Market narrative theme: MACRO_POLICY
- MIXED_EVENT_CONFLICT | NEUTRAL | w=12.212 | market_narrative | Narrative has mixed/conflicting drivers
...
- MIXED_EVENT_CONFLICT | NEUTRAL | w=9.28 | causal_intelligence | Causal context: MULTI_SOURCE_EVENT_CONSENSUS
