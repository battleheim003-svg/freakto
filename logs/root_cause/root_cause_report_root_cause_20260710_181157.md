...
Run ID                 : root_cause_20260710_181157
...
- MACRO_POLICY_PRESSURE: p=44.17% | score=72.6554 | dir=BEARISH | evidence=7 | verdict=SUPPORTING_CAUSE
- REGULATORY_ACCESS_OR_MODERNIZATION: p=13.12% | score=21.59 | dir=BULLISH | evidence=2 | verdict=WEAK_SUPPORTING_CAUSE
- MIXED_EVENT_CONFLICT: p=12.53% | score=20.6203 | dir=MIXED_OR_NEUTRAL | evidence=2 | verdict=WEAK_SUPPORTING_CAUSE
...
Evidence:
- MACRO_POLICY_PRESSURE | BEARISH | w=16.8804 | market_narrative | Market narrative theme: MACRO_POLICY
- TECHNICAL_STRUCTURE_MOMENTUM | BULLISH | w=16.05 | decision_engine_features | Decision Engine structure/trend/momentum evidence
- MIXED_EVENT_CONFLICT | NEUTRAL | w=12.6603 | market_narrative | Narrative has mixed/conflicting drivers
