...
- MACRO_POLICY_PRESSURE | BEARISH | w=12.0699 | market_narrative | Market narrative theme: MACRO_POLICY
...
- MIXED_EVENT_CONFLICT | NEUTRAL | w=9.4 | causal_intelligence | Causal context: MULTI_SOURCE_EVENT_CONSENSUS
- MIXED_EVENT_CONFLICT | NEUTRAL | w=9.0524 | market_narrative | Narrative has mixed/conflicting drivers
