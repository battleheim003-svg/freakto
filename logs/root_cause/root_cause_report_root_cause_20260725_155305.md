...
- REGULATORY_ACCESS_OR_MODERNIZATION | BULLISH | w=11.815 | sec_press_releases | SEC Announces Roundtable on Preparations for 24-Hour Trading
- LIQUIDITY_VOLUME_FLOW | NEUTRAL | w=11.68 | causal_intelligence | Causal context: STRUCTURE_BREAKOUT_WEAK_VOLUME_CONFIRMATION
...
- REGULATORY_RISK | MIXED_OR_NEUTRAL | w=7.1474 | market_narrative | Market narrative theme: REGULATORY_RISK
