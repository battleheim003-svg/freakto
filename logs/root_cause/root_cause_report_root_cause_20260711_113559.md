...
Run ID                 : root_cause_20260711_113559
...
- MACRO_POLICY_PRESSURE: p=42.23% | score=67.855 | dir=BEARISH | evidence=7 | verdict=SUPPORTING_CAUSE
- REGULATORY_ACCESS_OR_MODERNIZATION: p=13.44% | score=21.59 | dir=BULLISH | evidence=2 | verdict=WEAK_SUPPORTING_CAUSE
- MIXED_EVENT_CONFLICT: p=13.22% | score=21.2387 | dir=MIXED_OR_NEUTRAL | evidence=2 | verdict=WEAK_SUPPORTING_CAUSE
...
- MACRO_POLICY_PRESSURE | BEARISH | w=16.105 | market_narrative | Market narrative theme: MACRO_POLICY
- MIXED_EVENT_CONFLICT | NEUTRAL | w=12.0787 | market_narrative | Narrative has mixed/conflicting drivers
